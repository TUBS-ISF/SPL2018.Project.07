...
public class DialogSupport {
    ...
    public Optional<ResourceFigure> getResourceFigureEditedByUser(final ResourceFigure originalFigure) {
        ...
        FXMLLoader fxml = new FXMLLoader(getClass().getResource("/de/tubs/gol/DirectionDialogGui.fxml"));
        Parent root = null;
        try {
            root = fxml.load();
        } catch (IOException e) {
        ...
        DirectionDialogGuiController controller = fxml.getController();
        editDirectionDialog.getDialogPane().setContent(root);
